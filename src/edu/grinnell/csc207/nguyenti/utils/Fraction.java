...
public class Fraction {
    ...
    /**
     * If clone is called on something that isn't a fraction, it will return new
     * Fraction(-1)
     */
	...
	BigInteger resultNum = this.numerator.subtract(
		this.numerator.remainder(this.denominator)).divide(
		this.denominator);
	return resultNum;
    }
