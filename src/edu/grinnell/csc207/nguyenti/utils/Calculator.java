 ...
 * 
 *         I, Earnest Wheeler, sat next to Daniel Goldstein while writing
 *         evaluate ~
 * 
 */
...
public class Calculator {
    ...
    /**
     * evaluate evaluates a string expression and returns the expression,
     * storing it if stated.
     * 
     * @param expression
     * @return
     * @throws Exception
	...
	while (loopchecker) {
	    pen.println("Enter an expression or enter \"Quit\" to exit the calculator: ");
